 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'SMVMT_Ext_Sticky_Header_Customizer_Partials' ) ) {

	/**
	 * Customizer Partials initial setup
	 */
	class SMVMT_Ext_Sticky_Header_Customizer_Partials {
 ...
 */
SMVMT_Ext_Sticky_Header_Customizer_Partials::get_instance();
