...
if ( ! class_exists( 'SMVMT_Sticky_Header_Sections_Configs' ) ) {

	/**
	 * Register Sticky Header - Header Sections Customizer Configurations.
	 */
	class SMVMT_Sticky_Header_Sections_Configs extends SMVMT_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_config = array(
				array(
					'name'            => SMVMT_THEME_SETTINGS . '[header-above-stick]',
					'default'         => smvmt_get_option( 'header-above-stick' ),
					'type'            => 'control',
					'section'         => 'section-sticky-header',
					'title'           => __( 'Stick Above Header', 'smvmt-addon' ),
					'priority'        => 5,
					'control'         => 'checkbox',
				...
				array(
					'name'            => SMVMT_THEME_SETTINGS . '[header-below-stick]',
					'default'         => smvmt_get_option( 'header-below-stick' ),
					'type'            => 'control',
					'section'         => 'section-sticky-header',
					'title'           => __( 'Stick Below Header', 'smvmt-addon' ),
					'priority'        => 14,
					'control'         => 'checkbox',
				...
				array(
					...
					'type'     => 'section',
					'priority' => 10,
					'title'    => __( 'Sticky Header Button', 'smvmt-addon' ),
...
new SMVMT_Sticky_Header_Sections_Configs();
