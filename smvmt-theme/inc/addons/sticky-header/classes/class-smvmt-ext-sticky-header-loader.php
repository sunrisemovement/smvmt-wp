...
if ( ! class_exists( 'SMVMT_Ext_Sticky_Header_Loader' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class SMVMT_Ext_Sticky_Header_Loader {
		...
		public function new_customize_register( $wp_customize ) {
			 ...
			 */
			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/class-smvmt-sticky-header-panels-configs.php';

			/**
			 * Sections
			 */
			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/sections/class-smvmt-sticky-header-configs.php';

			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/sections/class-smvmt-sticky-header-colors-bg-configs.php';

			// Header Sections.
			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/sections/class-smvmt-sticky-header-sections-configs.php';

			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/sections/class-smvmt-sticky-above-header-colors-bg-configs.php';
			require_once SMVMT_EXT_STICKY_HEADER_DIR . 'classes/sections/class-smvmt-sticky-below-header-colors-bg-configs.php';
		}
		...
		public function preview_scripts() {
			wp_register_script( 'smvmt-sticky-header-customizer-preview-js', SMVMT_EXT_STICKY_HEADER_URI . 'assets/js/unminified/customizer-preview.js', array( 'customize-preview', 'smvmt-customizer-preview-js' ), SMVMT_THEME_VERSION, true );
			...
			wp_localize_script( 'smvmt-sticky-header-customizer-preview-js', 'astSticky', $localize_array );

			wp_enqueue_script( 'smvmt-sticky-header-customizer-preview-js' );
		}
...
*/
SMVMT_Ext_Sticky_Header_Loader::get_instance();
