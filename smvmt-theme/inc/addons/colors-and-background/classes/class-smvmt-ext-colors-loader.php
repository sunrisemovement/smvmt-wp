...
if ( ! class_exists( 'SMVMT_Ext_Colors_Loader' ) ) {
	...
	class SMVMT_Ext_Colors_Loader {
		...
		public function new_customize_register( $wp_customize ) {
			...
			require_once SMVMT_EXT_COLORS_DIR . 'classes/class-smvmt-ext-colors-panels-and-sections.php';

			// Sections.
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-archive.php';
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-content.php';
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-header.php';
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-primary-menu.php';
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-sidebar.php';
			require_once SMVMT_EXT_COLORS_DIR . 'classes/sections/class-smvmt-customizer-colors-single.php';
		...
		public function preview_scripts() {
			...
			wp_enqueue_script( 'smvmt-ext-colors-customize-preview-js', SMVMT_EXT_COLORS_URI . $js_path, array( 'customize-preview', 'smvmt-customizer-preview-js', 'smvmt-addon-customizer-preview-js' ), SMVMT_THEME_VERSION, true );
 ...
 */
SMVMT_Ext_Colors_Loader::get_instance();
