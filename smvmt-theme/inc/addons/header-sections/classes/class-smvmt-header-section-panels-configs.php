...
if ( ! class_exists( 'SMVMT_Header_Section_Panels_Configs' ) ) {

	/**
	 * Register Header Layout Customizer Configurations.
	 */
	class SMVMT_Header_Section_Panels_Configs extends SMVMT_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_config = array(
				...
				array(
					...
					'type'     => 'section',
					'title'    => __( 'Below Header', 'smvmt-addon' ),
				...
				array(
					...
					'type'     => 'section',
					'title'    => __( 'Above Header', 'smvmt-addon' ),
					'panel'    => 'panel-header-group',
					'priority' => 20,
				),
...
new SMVMT_Header_Section_Panels_Configs();
