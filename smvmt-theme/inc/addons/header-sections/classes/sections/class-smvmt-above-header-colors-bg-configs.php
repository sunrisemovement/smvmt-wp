...
if ( ! class_exists( 'SMVMT_Above_Header_Colors_Bg_Configs' ) ) {

	/**
	 * Register Header Layout Customizer Configurations.
	 */
	class SMVMT_Above_Header_Colors_Bg_Configs extends SMVMT_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_config = array(
				...
				array(
					...
					'parent'    => SMVMT_THEME_SETTINGS . '[above-header-background-styling]',
					'type'      => 'sub-control',
				...
				array(
					...
					'parent'     => SMVMT_THEME_SETTINGS . '[above-header-menu-colors]',
					'priority'   => 2,
					'type'       => 'sub-control',
					'section'    => 'section-above-header',
				...
				array(
					...
					'parent'     => SMVMT_THEME_SETTINGS . '[above-header-submenu-colors]',
					'priority'   => 3,
					'type'       => 'sub-control',
					'section'    => 'section-above-header',
					'control'    => 'smvmt-responsive-color',
				...
				array(
					...
					'parent'     => SMVMT_THEME_SETTINGS . '[above-header-content-section-styling]',
					'priority'   => 5,
					'type'       => 'sub-control',
					'control'    => 'smvmt-responsive-color',
					'section'    => 'section-above-header',
...
new SMVMT_Above_Header_Colors_Bg_Configs();
