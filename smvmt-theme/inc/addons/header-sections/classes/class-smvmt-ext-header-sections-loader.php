...
if ( ! class_exists( 'SMVMT_Ext_Header_Sections_Loader' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class SMVMT_Ext_Header_Sections_Loader {
		...
		public function theme_defaults( $defaults ) {
			...
			$defaults['below-header-section-1-html']              = __( '1-800-000-000 — hello@example.com', 'smvmt-addon' );
			$defaults['below-header-section-2']                   = 'none';
			$defaults['below-header-section-2-html']              = __( '1-800-000-000 — hello@example.com', 'smvmt-addon' );
			...
			$defaults['above-header-section-1-html']              = __( '1-800-000-000 — hello@example.com', 'smvmt-addon' );
			$defaults['above-header-section-2']                   = 'search';
			$defaults['above-header-section-2-html']              = __( '1-800-000-000 — hello@example.com', 'smvmt-addon' );
		...
		public function new_customize_register( $wp_customize ) {
			 ...
			 */
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/class-smvmt-header-section-panels-configs.php';
			/**
			 * Register Partials
			 */
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/class-smvmt-customizer-header-sections-partials.php';

			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-above-header-configs.php';
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-below-header-configs.php';
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-above-header-typo-configs.php';
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-below-header-typo-configs.php';
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-above-header-colors-bg-configs.php';
			require_once SMVMT_EXT_HEADER_SECTIONS_DIR . 'classes/sections/class-smvmt-below-header-colors-bg-configs.php';
		}
		...
		public function preview_scripts() {
			...
			if ( SCRIPT_DEBUG ) {
				wp_enqueue_script( 'smvmt-below-header-customize-preview-js', SMVMT_EXT_HEADER_SECTIONS_URL . 'assets/js/unminified/customizer-preview.js', array( 'customize-preview', 'smvmt-customizer-preview-js' ), SMVMT_THEME_VERSION, true );
			} else {
				wp_enqueue_script( 'smvmt-below-header-customize-preview-js', SMVMT_EXT_HEADER_SECTIONS_URL . 'assets/js/minified/customizer-preview.min.js', array( 'customize-preview', 'smvmt-customizer-preview-js' ), SMVMT_THEME_VERSION, true );
			}
...
*/
SMVMT_Ext_Header_Sections_Loader::get_instance();
