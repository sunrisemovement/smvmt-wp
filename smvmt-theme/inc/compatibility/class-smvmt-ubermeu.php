...
/**
 * smvmt Ubermenu Compatibility
 */
if ( ! class_exists( 'SMVMT_Ubermeu' ) ) :
	...
	class SMVMT_Ubermeu {
		...
		public function __construct() {
			add_filter( 'smvmt_enable_mobile_menu_buttons', array( $this, 'disable_primary_menu_toggle' ), 30 );
		}

		/**
		 * Disable the Mobile Menu toggles from smvmt if Uber Menu is used.
		 *
		 * @since  1.1.7
