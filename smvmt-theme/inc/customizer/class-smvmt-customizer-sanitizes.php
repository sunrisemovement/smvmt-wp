<?php
/**
 * smvmt Theme Customizer Sanitize.
 *
 * @package     smvmt
 * @author      smvmt
 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'SMVMT_Customizer_Sanitizes' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class SMVMT_Customizer_Sanitizes {
		...
		public static function validate_email( $validity, $value ) {
			if ( ! is_email( $value ) ) {
				$validity->add( 'required', __( 'Enter valid email address!', 'smvmt' ) );
			}
			return $validity;
		}
 ...
 */
SMVMT_Customizer_Sanitizes::get_instance();
