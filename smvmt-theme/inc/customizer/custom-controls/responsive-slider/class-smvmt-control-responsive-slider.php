 ...
 */
class SMVMT_Control_Responsive_Slider extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'smvmt-responsive-slider';
	...
	protected function content_template() {
		$reset = __( 'Back to default', 'smvmt' );
		?>
		<label for="">
			<# if ( data.label ) { #>
				<span class="customize-control-title">{{{ data.label }}}</span>
				<ul class="smvmt-responsive-slider-btns">
			...
			<div class="wrapper">
				<div class="input-field-wrapper desktop active">
					...
					<div class="SMVMT_range_value">
						<input type="number" data-id='desktop' class="smvmt-responsive-range-value-input" value="{{ value_desktop }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="smvmt-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				</div>
				<div class="input-field-wrapper tablet">
					...
					<div class="SMVMT_range_value">
						<input type="number" data-id='tablet' class="smvmt-responsive-range-value-input" value="{{ value_tablet }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="smvmt-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				...
				<div class="input-field-wrapper mobile">
					...
					<div class="SMVMT_range_value">
						<input type="number" data-id='mobile' class="smvmt-responsive-range-value-input" value="{{ value_mobile }}" {{{ data.inputAttrs }}} ><#
						if ( data.suffix ) {
						#><span class="smvmt-range-unit">{{ data.suffix }}</span><#
						} #>
					</div>
				</div>
				<div class="smvmt-responsive-slider-reset">
					<span class="dashicons dashicons-image-rotate smvmt-control-tooltip" title="<?php echo esc_html( $reset ); ?>" ></span>
