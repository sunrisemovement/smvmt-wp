 ...
 */
if ( ! function_exists( 'SMVMT_widget_tag_cloud_args' ) ) :
	 ...
	 */
	function SMVMT_widget_tag_cloud_args( $args = array() ) {
		...
		return apply_filters( 'SMVMT_widget_tag_cloud_args', $args );
	}
	add_filter( 'widget_tag_cloud_args', 'SMVMT_widget_tag_cloud_args', 90 );
 ...
 */
if ( ! function_exists( 'SMVMT_filter_widget_tag_cloud' ) ) :
	 ...
	 */
	function SMVMT_filter_widget_tag_cloud( $tags_data ) {
		...
		return apply_filters( 'SMVMT_filter_widget_tag_cloud', $tags_data );
	}
	add_filter( 'wp_generate_tag_cloud_data', 'SMVMT_filter_widget_tag_cloud' );
 ...
 */
if ( ! function_exists( 'SMVMT_widgets_init' ) ) :
	...
	function SMVMT_widgets_init() {
		...
		register_sidebar(
			apply_filters(
				'SMVMT_widgets_init',
				array(
					'name'          => esc_html__( 'Main Sidebar', 'smvmt' ),
					'id'            => 'sidebar-1',
					'description'   => '',
		...
		register_sidebar(
			apply_filters(
				'SMVMT_advanced_footer_widget_1_args',
				array(
					'name'          => esc_html__( 'Footer Widget Area 1', 'smvmt' ),
		...
		register_sidebar(
			apply_filters(
				'SMVMT_advanced_footer_widget_2_args',
				array(
					'name'          => esc_html__( 'Footer Widget Area 2', 'smvmt' ),
		...
		register_sidebar(
			apply_filters(
				'SMVMT_advanced_footer_widget_3_args',
				array(
					'name'          => esc_html__( 'Footer Widget Area 3', 'smvmt' ),
		...
		register_sidebar(
			apply_filters(
				'SMVMT_advanced_footer_widget_4_args',
				array(
					'name'          => esc_html__( 'Footer Widget Area 4', 'smvmt' ),
	...
	add_action( 'widgets_init', 'SMVMT_widgets_init' );
