...
if ( ! class_exists( 'Gutenberg_Editor_CSS' ) ) :
	...
	class Gutenberg_Editor_CSS {
		...
		public static function get_css() {
			...
			$site_content_width          = smvmt_get_option( 'site-content-width', 1200 ) + 56;
			...
			if ( 'default' === $container_layout || '' === $container_layout ) {
				$container_layout = smvmt_get_option( 'single-' . get_post_type() . '-content-layout' );

				if ( 'default' === $container_layout ) {
					$container_layout = smvmt_get_option( 'site-content-layout' );
				}
			}
			...
			$desktop_css = array(
				...
				'.smvmt-separate-container .edit-post-visual-editor, .smvmt-page-builder-template .edit-post-visual-editor, .smvmt-plain-container .edit-post-visual-editor, .smvmt-separate-container #wpwrap #editor .edit-post-visual-editor' => smvmt_get_background_obj( $box_bg_obj ),
				'.editor-post-title__block,.editor-default-block-appender,.editor-block-list__block' => array(
					'max-width' => smvmt_get_css_value( $site_content_width, 'px' ),
				),
				'.editor-block-list__block[data-align=wide]' => array(
					'max-width' => smvmt_get_css_value( $site_content_width + 200, 'px' ),
				),
				...
				'.editor-post-title__block .editor-post-title__input' => array(
					'font-family' => ( 'inherit' === $headings_font_family ) ? smvmt_get_font_family( $body_font_family ) : smvmt_get_font_family( $headings_font_family ),
				...
				'blockquote .editor-rich-text__tinymce a' => array(
					'color' => smvmt_hex_to_rgba( $link_color, 1 ),
				),
				'blockquote'                              => array(
					'border-color' => smvmt_hex_to_rgba( $link_color, 0.05 ),
				),
				...
				'.wc-block-grid__product .wc-block-grid__product-onsale' => array(
					...
					'color'            => smvmt_get_foreground_color( $theme_color ),
				),
			...
			$css .= smvmt_parse_css( $desktop_css );
			...
			$css .= smvmt_parse_css( $css_prod_button_tablet, '', '768' );
			...
			$css .= smvmt_parse_css( $css_prod_button_mobile, '', '544' );

			if ( SMVMT_Dynamic_CSS::page_builder_button_style_css() ) {
				$button_desktop_css = array(
					...
					'.wp-block-button .wp-block-button__link' => array(
						'border-style'        => 'solid',
						'border-top-width'    => ( isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ) ? smvmt_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '1px',
						'border-right-width'  => ( isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ) ? smvmt_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '1px',
						'border-left-width'   => ( isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ) ? smvmt_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '1px',
						'border-bottom-width' => ( isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ) ? smvmt_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '1px',
				...
				$css .= smvmt_parse_css( $button_desktop_css );
				...
				$css .= smvmt_parse_css( $css_global_button_tablet, '', '768' );
				...
				$css .= smvmt_parse_css( $css_global_button_mobile, '', '544' );
			}
			...
			$css .= smvmt_parse_css( $tablet_css, '', '768' );
			...
			$css .= smvmt_parse_css( $mobile_css, '', '544' );
			...
			if ( 'page-builder' === $container_layout ) {
				...
				$css .= smvmt_parse_css( $page_builder_css );
			}
			...
			if ( 'page-builder' === $container_layout || 'plain-container' === $container_layout ) {
				...
				$css .= smvmt_parse_css( $aligned_full_content_css );
			}
			...
			if ( 'page-builder' === $container_layout ) {
				...
				$css .= smvmt_parse_css( $full_width_streched_css );
			}
			...
			if ( ( in_array( $pagenow, array( 'post-new.php' ) ) && ! isset( $post ) ) || 'content-boxed-container' === $container_layout || 'boxed-container' === $container_layout ) {
				$boxed_container = array(
					'.editor-writing-flow'       => array(
						'max-width'        => smvmt_get_css_value( $site_content_width - 56, 'px' ),
						'margin'           => '0 auto',
					...
					'.editor-block-list__block'  => array(
						'max-width' => 'calc(' . smvmt_get_css_value( $site_content_width, 'px' ) . ' - 6.67em)',
					),
					'.editor-block-list__block[data-align=wide]' => array(
						'margin-left'  => '-20px',
						'margin-right' => '-20px',
				...
				$css .= smvmt_parse_css( $boxed_container );
