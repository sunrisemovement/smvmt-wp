 ...
 * Theme Options
 */
if ( ! class_exists( 'SMVMT_Theme_Options' ) ) {
	/**
	 * Theme Options
	 */
	class SMVMT_Theme_Options {
		...
		public static function defaults() {
			...
			return apply_filters(
				...
				array(
					...
					'footer-sml-section-1-credit'         => __( 'Copyright &copy; [current_year] [site_title]', 'smvmt' ),
					'footer-sml-section-2'                => '',
					'footer-sml-section-2-credit'         => __( 'Copyright &copy; [current_year] [site_title]', 'smvmt' ),
					'footer-sml-dist-equal-align'         => true,
					'footer-sml-divider'                  => 1,
					'footer-sml-divider-color'            => '#7a7a7a',
					'footer-layout-width'                 => 'content',
					// General.
					'smvmt-header-retina-logo'              => '',
					'smvmt-header-logo-width'               => '',
					'smvmt-header-responsive-logo-width'    => array(
						'desktop' => '',
						'tablet'  => '',
						'mobile'  => '',
					),
					...
					// Site Layout.
					'site-layout'                         => 'smvmt-full-width-layout',
		...
		public static function get_db_options() {
			self::$db_options_no_defaults = get_option( SMVMT_THEME_SETTINGS );
 ...
 */
SMVMT_Theme_Options::get_instance();
