...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<div class="comments-count-wrapper">
			<h3 class="comments-title">
				...
				$comments_title = apply_filters(
					'SMVMT_comment_form_title',
					sprintf( // WPCS: XSS OK.
						/* translators: 1: number of comments */
						esc_html( _nx( '%1$s thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'smvmt' ) ),
		...
		<ol class="smvmt-comment-list">
			<?php
			wp_list_comments(
				array(
					'callback' => 'smvmt_theme_comment',
					'style'    => 'ol',
				)
			);
			?>
		</ol><!-- .smvmt-comment-list -->
